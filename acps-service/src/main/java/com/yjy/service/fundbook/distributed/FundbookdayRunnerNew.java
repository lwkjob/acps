package com.yjy.service.fundbook.distributed;
 ...
 */
public class FundbookdayRunnerNew {
    private Logger logger = LoggerFactory.getLogger(FundbookdayRunnerNew.class);
...
//                jedisTemplate.set(mapKey, fundbookday.getBalance().doubleValue() + "");
                            ...
                            if (insertFundbookdays.size()>0&&insertFundbookdays.size() % 5000 == 0) {
                                //每3万条插入一次
