...
public class FundConstant {
    ...
    public static  final String FUNDMONTHTEMP_TABLE_NAME_PRE ="fundmonthtemp"; //月结临时表名前缀+yyyyMM
    ...
    public static String REPORT_OF_DAY_PUB_CHILD = REPORT_OF_DAY_PUB_LISSTENER +"/CHILD"; //子服务写入
