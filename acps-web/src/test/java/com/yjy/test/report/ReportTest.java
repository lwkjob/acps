...
public class ReportTest {
    ...
    public void findPaginationMonthList(){
        ...
        Pagination<FundsMonth> quereyPagination= fundsMonthService.findPaginationMonthList(pagination, fundsMonthExample);
...
//          goodsOutExample.setBuyerLinkman("梁建");
         goodsOutService.findPaginationGoodsOutList(pagination, goodsOutExample);
