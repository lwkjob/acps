...
import com.yjy.common.entity.report.FundsBanlaceExample;
...
public interface FundsBanlaceMapper {
    ...
    int insert(FundsBalance record);

    int insertSelective(FundsBalance record);

    List<FundsBalance> selectByExample(FundsBanlaceExample example);
    ...
    FundsBalance selectByPrimaryKey(Long id);

    int updateByExampleSelective(@Param("record") FundsBalance record, @Param("example") FundsBanlaceExample example);

    int updateByExample(@Param("record") FundsBalance record, @Param("example") FundsBanlaceExample example);

    int updateByPrimaryKeySelective(FundsBalance record);
    ...
    int updateByPrimaryKey(FundsBalance record);
}