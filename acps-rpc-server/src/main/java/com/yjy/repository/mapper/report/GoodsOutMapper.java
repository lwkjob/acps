...
import com.yjy.common.entity.report.GoodsOutExample;
...
public interface GoodsOutMapper {
    ...
    @Delete({
        "delete from reportsaleronlinegoodstoout",
        "where Id = #{id,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long id);

    @Insert({
        "insert into reportsaleronlinegoodstoout (InvoiceType, ParentId, ",
    ...
    @Select({
        ...
        "Balance",
        "from reportsaleronlinegoodstoout",
        "where Id = #{id,jdbcType=BIGINT}"
    })
    ...
    @Update({
        "update reportsaleronlinegoodstoout",
