...
public class TFundsMonthPaginationVo implements org.apache.thrift.TBase<TFundsMonthPaginationVo, TFundsMonthPaginationVo._Fields>, java.io.Serializable, Cloneable, Comparable<TFundsMonthPaginationVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFundsMonthPaginationVo");
  ...
  static {
    schemes.put(StandardScheme.class, new TFundsMonthPaginationVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TFundsMonthPaginationVoTupleSchemeFactory());
  }
  ...
  public List<TFundsMonthResponseReport> data; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.DATA, new org.apache.thrift.meta_data.FieldMetaData("data", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFundsMonthResponseReport.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFundsMonthPaginationVo.class, metaDataMap);
  }

  public TFundsMonthPaginationVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TFundsMonthPaginationVo(TFundsMonthPaginationVo other) {
    ...
    if (other.isSetData()) {
      List<TFundsMonthResponseReport> __this__data = new ArrayList<TFundsMonthResponseReport>(other.data.size());
      for (TFundsMonthResponseReport other_element : other.data) {
        __this__data.add(new TFundsMonthResponseReport(other_element));
      }
      this.data = __this__data;
    }
  }

  public TFundsMonthPaginationVo deepCopy() {
    return new TFundsMonthPaginationVo(this);
  }
  ...
  public TFundsMonthPaginationVo setPageSize(int pageSize) {
  ...
  public TFundsMonthPaginationVo setPageCount(int pageCount) {
  ...
  public TFundsMonthPaginationVo setCount(int count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public TFundsMonthPaginationVo setCurrentPage(int currentPage) {
  ...
  public java.util.Iterator<TFundsMonthResponseReport> getDataIterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void addToData(TFundsMonthResponseReport elem) {
    if (this.data == null) {
      this.data = new ArrayList<TFundsMonthResponseReport>();
    }
    this.data.add(elem);
  }

  public List<TFundsMonthResponseReport> getData() {
    return this.data;
  }

  public TFundsMonthPaginationVo setData(List<TFundsMonthResponseReport> data) {
    this.data = data;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        setData((List<TFundsMonthResponseReport>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TFundsMonthPaginationVo)
      return this.equals((TFundsMonthPaginationVo)that);
    return false;
  }

  public boolean equals(TFundsMonthPaginationVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TFundsMonthPaginationVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TFundsMonthPaginationVo(");
    boolean first = true;
  ...
  private static class TFundsMonthPaginationVoStandardSchemeFactory implements SchemeFactory {
    public TFundsMonthPaginationVoStandardScheme getScheme() {
      return new TFundsMonthPaginationVoStandardScheme();
    }
  }

  private static class TFundsMonthPaginationVoStandardScheme extends StandardScheme<TFundsMonthPaginationVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFundsMonthPaginationVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new ArrayList<TFundsMonthResponseReport>(_list0.size);
                TFundsMonthResponseReport _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new TFundsMonthResponseReport();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFundsMonthPaginationVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (TFundsMonthResponseReport _iter3 : struct.data)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TFundsMonthPaginationVoTupleSchemeFactory implements SchemeFactory {
    public TFundsMonthPaginationVoTupleScheme getScheme() {
      return new TFundsMonthPaginationVoTupleScheme();
    }
  }

  private static class TFundsMonthPaginationVoTupleScheme extends TupleScheme<TFundsMonthPaginationVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFundsMonthPaginationVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (TFundsMonthResponseReport _iter4 : struct.data)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFundsMonthPaginationVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.data = new ArrayList<TFundsMonthResponseReport>(_list5.size);
          TFundsMonthResponseReport _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new TFundsMonthResponseReport();
            _elem6.read(iprot);
