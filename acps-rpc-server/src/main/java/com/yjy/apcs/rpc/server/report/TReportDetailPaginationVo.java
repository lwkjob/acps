...
public class TReportDetailPaginationVo implements org.apache.thrift.TBase<TReportDetailPaginationVo, TReportDetailPaginationVo._Fields>, java.io.Serializable, Cloneable, Comparable<TReportDetailPaginationVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TReportDetailPaginationVo");
  ...
  static {
    schemes.put(StandardScheme.class, new TReportDetailPaginationVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TReportDetailPaginationVoTupleSchemeFactory());
  }
  ...
  public List<TResponseReportDetail> data; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.DATA, new org.apache.thrift.meta_data.FieldMetaData("data", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TResponseReportDetail.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TReportDetailPaginationVo.class, metaDataMap);
  }

  public TReportDetailPaginationVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TReportDetailPaginationVo(TReportDetailPaginationVo other) {
    ...
    if (other.isSetData()) {
      List<TResponseReportDetail> __this__data = new ArrayList<TResponseReportDetail>(other.data.size());
      for (TResponseReportDetail other_element : other.data) {
        __this__data.add(new TResponseReportDetail(other_element));
      }
      this.data = __this__data;
    }
  }

  public TReportDetailPaginationVo deepCopy() {
    return new TReportDetailPaginationVo(this);
  }
  ...
  public TReportDetailPaginationVo setPageSize(int pageSize) {
  ...
  public TReportDetailPaginationVo setPageCount(int pageCount) {
  ...
  public TReportDetailPaginationVo setCount(int count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public TReportDetailPaginationVo setCurrentPage(int currentPage) {
  ...
  public java.util.Iterator<TResponseReportDetail> getDataIterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void addToData(TResponseReportDetail elem) {
    if (this.data == null) {
      this.data = new ArrayList<TResponseReportDetail>();
    }
    this.data.add(elem);
  }

  public List<TResponseReportDetail> getData() {
    return this.data;
  }

  public TReportDetailPaginationVo setData(List<TResponseReportDetail> data) {
    this.data = data;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        setData((List<TResponseReportDetail>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TReportDetailPaginationVo)
      return this.equals((TReportDetailPaginationVo)that);
    return false;
  }

  public boolean equals(TReportDetailPaginationVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TReportDetailPaginationVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TReportDetailPaginationVo(");
    boolean first = true;
  ...
  private static class TReportDetailPaginationVoStandardSchemeFactory implements SchemeFactory {
    public TReportDetailPaginationVoStandardScheme getScheme() {
      return new TReportDetailPaginationVoStandardScheme();
    }
  }

  private static class TReportDetailPaginationVoStandardScheme extends StandardScheme<TReportDetailPaginationVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TReportDetailPaginationVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new ArrayList<TResponseReportDetail>(_list0.size);
                TResponseReportDetail _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new TResponseReportDetail();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TReportDetailPaginationVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (TResponseReportDetail _iter3 : struct.data)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TReportDetailPaginationVoTupleSchemeFactory implements SchemeFactory {
    public TReportDetailPaginationVoTupleScheme getScheme() {
      return new TReportDetailPaginationVoTupleScheme();
    }
  }

  private static class TReportDetailPaginationVoTupleScheme extends TupleScheme<TReportDetailPaginationVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TReportDetailPaginationVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (TResponseReportDetail _iter4 : struct.data)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TReportDetailPaginationVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.data = new ArrayList<TResponseReportDetail>(_list5.size);
          TResponseReportDetail _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new TResponseReportDetail();
            _elem6.read(iprot);
