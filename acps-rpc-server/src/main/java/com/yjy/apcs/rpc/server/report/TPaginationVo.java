...
public class TPaginationVo implements org.apache.thrift.TBase<TPaginationVo, TPaginationVo._Fields>, java.io.Serializable, Cloneable, Comparable<TPaginationVo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPaginationVo");
  ...
  static {
    schemes.put(StandardScheme.class, new TPaginationVoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TPaginationVoTupleSchemeFactory());
  }
  ...
  public List<TResponseReport> data; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.DATA, new org.apache.thrift.meta_data.FieldMetaData("data", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TResponseReport.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPaginationVo.class, metaDataMap);
  }

  public TPaginationVo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TPaginationVo(TPaginationVo other) {
    ...
    if (other.isSetData()) {
      List<TResponseReport> __this__data = new ArrayList<TResponseReport>(other.data.size());
      for (TResponseReport other_element : other.data) {
        __this__data.add(new TResponseReport(other_element));
      }
      this.data = __this__data;
    }
  }

  public TPaginationVo deepCopy() {
    return new TPaginationVo(this);
  }
  ...
  public TPaginationVo setPageSize(int pageSize) {
  ...
  public TPaginationVo setPageCount(int pageCount) {
  ...
  public TPaginationVo setCount(int count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public TPaginationVo setCurrentPage(int currentPage) {
  ...
  public java.util.Iterator<TResponseReport> getDataIterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void addToData(TResponseReport elem) {
    if (this.data == null) {
      this.data = new ArrayList<TResponseReport>();
    }
    this.data.add(elem);
  }

  public List<TResponseReport> getData() {
    return this.data;
  }

  public TPaginationVo setData(List<TResponseReport> data) {
    this.data = data;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        setData((List<TResponseReport>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TPaginationVo)
      return this.equals((TPaginationVo)that);
    return false;
  }

  public boolean equals(TPaginationVo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TPaginationVo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TPaginationVo(");
    boolean first = true;
  ...
  private static class TPaginationVoStandardSchemeFactory implements SchemeFactory {
    public TPaginationVoStandardScheme getScheme() {
      return new TPaginationVoStandardScheme();
    }
  }

  private static class TPaginationVoStandardScheme extends StandardScheme<TPaginationVo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPaginationVo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new ArrayList<TResponseReport>(_list0.size);
                TResponseReport _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new TResponseReport();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPaginationVo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (TResponseReport _iter3 : struct.data)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TPaginationVoTupleSchemeFactory implements SchemeFactory {
    public TPaginationVoTupleScheme getScheme() {
      return new TPaginationVoTupleScheme();
    }
  }

  private static class TPaginationVoTupleScheme extends TupleScheme<TPaginationVo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPaginationVo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (TResponseReport _iter4 : struct.data)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPaginationVo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.data = new ArrayList<TResponseReport>(_list5.size);
          TResponseReport _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new TResponseReport();
            _elem6.read(iprot);
